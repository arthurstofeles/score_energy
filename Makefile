...
setup:
	docker network create score-energy_front || true
...
shell:
	docker-compose -f docker-compose.yml stop score-energy
	docker-compose -f docker-compose.yml run --rm --service-ports score-energy bash
